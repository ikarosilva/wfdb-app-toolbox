...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /home/ikaro/wfdb/database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /home/ikaro/wfdb/database).
...
# define DEFWFDB	". /home/ikaro/wfdb/database"
#else
# define DEFWFDB ". /home/ikaro/wfdb/database http://physionet.org/physiobank/database"
#endif
