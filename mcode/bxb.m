...
%       This can be used to read a report File that has been previously
...
% %Compares SQRS detector with the MITDB ATR annotations
%
...
if(~isempty(recName))
    ...
    %that the user just wants to load the 'reportFile' variable into the
